...
<div class="container-fluid bg-secondary mb-5">
	<div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
		<h1 class="font-weight-semi-bold text-uppercase mb-3">Login Pelanggan</h1>
...
<div class="container-fluid pt-5">
	<div class="text-center mb-4">
		<h2 class="section-title px-5"><span class="px-2">Login Pelanggan</span></h2>
	</div>
			...
			<div class="contact-form">
				...
				<form action="<?= base_url('pelanggan/login') ?>" method="POST">
					...
					<div>
						...
						<a href="<?= base_url('pelanggan/register') ?>" class="btn btn-warning">Registrasi</a>
					</div>
				</form>
			</div>
		</div>
