...
<div class="container-fluid pt-5">
	<div class="text-center mb-4">
		<h2 class="section-title px-5"><span class="px-2">Uplaod Bukti Pembayaran</span></h2>
	</div>
			...
			<div class="contact-form">
				...
				<form action="<?= base_url('pesanan/bayar/' . $detail->id_pesanan) ?>" method="post" enctype="multipart/form-data">
					<div class="control-group">
						<input type="text" class="form-control" id="name" name="atas_nama" placeholder="Atas Nama" />
					...
					<div>
						<button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton">
							Uplaod Bukti Pembayaran</button>
					</div>
				</form>
			</div>
		</div>
		<div class="col-lg-5 mb-5">
			<h5 class="font-weight-semi-bold mb-3">Transfer Ke Rekening</h5>
			<div class="d-flex flex-column mb-3">
				<h5 class="font-weight-semi-bold mb-3">BCA</h5>
				<p class="mb-2"></i>Atas Nama : Ahmadi</p>
				<p class="mb-2"></i>No Rekening : 98-291821-21-019</p>
			</div>
			<div class="d-flex flex-column">
				<h5 class="font-weight-semi-bold mb-3">BRI</h5>
				<p class="mb-2"></i>Atas Nama : Jaenal</p>
				<p class="mb-2"></i>No Rekening : 98-291821-21-019</p>
			</div>
		</div>
	</div>
