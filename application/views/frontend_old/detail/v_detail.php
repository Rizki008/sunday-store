		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-12">
				<div class="product-details-content">
					...
					<span>Rp. <?= number_format($produk->harga - ($produk->diskon / 100 * $produk->harga)) ?></span>
					<div class="in-stock">
						<p>Stok :
					...
					<div class="pro-dec-categories">
						<ul>
							<li class="categories-title">Deskripsi :</li>
					...
					<div class="product-wrapper">
						...
						<div class="product-content text-left">
							...
							<div class="product-price-wrapper">
								<?php if ($product->diskon == 0) { ?>
									<span>Rp. <?= number_format($product->harga - ($product->diskon / 100 * $product->harga)) ?> -</span>
								<?php } elseif ($product->diskon > 1) { ?>
									<span>Rp. <?= number_format($product->harga - ($product->diskon / 100 * $product->harga)) ?> -</span>
